...
inputFiles = [
	...
	[file: 'PRD/PRD-001-Bausteinsicht.adoc', formats: ['html']],
	[file: 'spec/01_use_cases.adoc', formats: ['html']],
	[file: 'spec/02_cli_specification.adoc', formats: ['html']],
	[file: 'spec/03_data_models.adoc', formats: ['html']],
	[file: 'spec/04_acceptance_criteria.adoc', formats: ['html']],
	[file: 'spec/05_sync_specification.adoc', formats: ['html']],
	/** inputFiles **/
]
...
microsite.with {
    ...
    menu = ['tutorial':'Tutorial', 'manual':'User Manual', 'PRD':'PRD', 'Specification':'Specification', 'arc42':'Architecture', 'ADR':'ADR', 'Development':'Development']
