...
[plantuml, tutorial-containers, svg]
....
@startuml
...
See the link:../spec/07_template_guide.html[Template Guide] for the full attribute reference and advanced styling (custom shapes, per-kind fonts and sizing).
