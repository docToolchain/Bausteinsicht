                ...
                <div class="col-md-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header" style="background-color: #2d5a87; color: white;">
                            <h5 class="mb-0">2. Get your diagram</h5>
                            <small>bausteinsicht sync</small>
                        </div>
                        <div class="card-body d-flex align-items-center justify-content-center" style="padding: 1rem;">
                            <img src="images/arc42/architecture-context.png"
                                 alt="System Context diagram generated by Bausteinsicht"
                                 style="max-width: 100%; height: auto; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.12);" />
                        </div>
                    </div>
                </div>
            </div>
