...
4. It applies these to the new element on the diagram
...
**Element templates** use an `<object>` wrapper:
[source,xml]
----
<object label="Container Name"
        bausteinsicht_template="container">  <!--1-->
  <mxCell style="rounded=1;fillColor=#438DD5;..." <!--2-->
          vertex="1" parent="1">
    <mxGeometry width="200" height="120" />   <!--3-->
  </mxCell>
</object>
----
<1> The `bausteinsicht_template` attribute must match the element kind name from your model's `specification.elements`
<2> The `style` string is copied to new elements
...
<object label="Database"
  ...
  <mxCell style="shape=cylinder3;whiteSpace=wrap;html=1;fillColor=#60A917;fontColor=#ffffff;strokeColor=#4B8412;size=12;fontSize=11;align=center;verticalAlign=middle;"
          vertex="1" parent="1">
...
| `label` | No | Labels come from the model (title, technology, description)
