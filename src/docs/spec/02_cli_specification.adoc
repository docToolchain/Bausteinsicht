...
* Creates a new view or updates an existing one with the same key.
* Uses comment-preserving insertion to update the JSONC file.

**Exit codes:**

* `0` -- view added/updated successfully
* `1` -- scope or include element not found, or missing required flag
* `2` -- model file not found or I/O error
