...
[source,xml]
----
<object label="&lt;b&gt;REST API&lt;/b&gt;&lt;br&gt;&lt;font color=&quot;#666666&quot;&gt;[Spring Boot]&lt;/font&gt;&lt;br&gt;&lt;font color=&quot;#999999&quot;&gt;Handles all HTTP requests&lt;/font&gt;"
...
Labels use HTML formatting with `html=1` in the style. HTML is XML-entity-escaped in the `label` attribute.

The label format has up to three lines:

. **Title** — bold (`<b>Title</b>`)
. **Technology** — grey `#666666`, wrapped in square brackets (`<font color="#666666">[Technology]</font>`)
. **Description** — lighter grey `#999999` (`<font color="#999999">Description</font>`)

Lines are separated by `<br>`. Empty technology or description lines are omitted.
...
| **REST API** +
[Spring Boot] (grey) +
Handles all HTTP requests (lighter grey)
| `&lt;b&gt;REST API&lt;/b&gt;&lt;br&gt;&lt;font color=&quot;#666666&quot;&gt;[Spring Boot]&lt;/font&gt;&lt;br&gt;&lt;font color=&quot;#999999&quot;&gt;Handles all HTTP requests&lt;/font&gt;`

| **Customer** +
End user (lighter grey, no technology)
| `&lt;b&gt;Customer&lt;/b&gt;&lt;br&gt;&lt;font color=&quot;#999999&quot;&gt;End user&lt;/font&gt;`
|===
