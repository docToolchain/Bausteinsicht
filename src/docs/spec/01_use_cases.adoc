...
[plantuml, uc02-define-elements, svg]
....
@startuml
start
:Architect opens model file in IDE;
...
[plantuml, uc03-forward-sync, svg]
....
@startuml
start
...
[plantuml, uc04-reverse-sync, svg]
....
@startuml
start
