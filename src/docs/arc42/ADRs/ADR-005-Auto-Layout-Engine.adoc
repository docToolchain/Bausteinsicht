...
Extended by link:ADR-013-Nested-Layout-Mode.html[ADR-013] (adds the `nested` concentric-container layout mode). The decision below is unchanged; ADR-013 records a later, additive layout mode and does not supersede it.
