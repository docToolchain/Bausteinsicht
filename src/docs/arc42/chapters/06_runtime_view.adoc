...
image::arc42/architecture-sequence-sync-command.svg[Sync Command,width=80%]
...
image::arc42/architecture-sequence-watch-mode.svg[Watch Mode,width=80%]
...
image::arc42/architecture-sequence-init-command.svg[Init Command,width=80%]
...
image::arc42/architecture-sequence-llm-driven-modification.svg[LLM-Driven Modification,width=80%]
...
image::arc42/architecture-sequence-import-from-external-formats.svg[Import from Structurizr / LikeC4 / XMI,width=80%]
...
image::arc42/architecture-sequence-repl-save.svg[REPL Save,width=80%]
...
image::arc42/architecture-sequence-stale-detection.svg[Stale Detection,width=80%]
...
image::arc42/architecture-sequence-error-recovery.svg[Error and Recovery,width=80%]
...
image::arc42/architecture-sequence-add-family.svg[Add Family,width=80%]
...
image::arc42/architecture-sequence-snapshot-management.svg[Snapshot Management,width=80%]
...
image::arc42/architecture-sequence-diff-and-changelog.svg[Diff and Changelog,width=80%]
...
image::arc42/architecture-sequence-export-family.svg[Export Family,width=80%]
...
image::arc42/architecture-sequence-analysis-suite.svg[Analysis Suite,width=80%]
...
image::arc42/architecture-sequence-validate-standalone.svg[Validate Standalone,width=80%]
...
image::arc42/architecture-sequence-tooling-commands.svg[Tooling Commands,width=80%]
...
image::arc42/architecture-sequence-interactive-extras.svg[Overlay and ADR,width=80%]
